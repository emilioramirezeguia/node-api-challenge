...
Middleware is a function that does something to the data passed along in your request such as validate information requirements before passing it along to the final request handler. If there's something wrong along the process, it will stop the request and return an error message.

- [ ] Describe a Resource?

A resource is an entry in the database with information that's been requested by the server.

- [ ] What can the API return to help clients know if a request was successful?

It can return a status code such as 200(ok) for get requests or 201(created) for post requests along the resource requested and/or a success message in JSON format.

- [ ] How can we partition our application into sub-applications?

We can partition them by using the Express Router and bundling routes specific to a category of data into separate directories.
